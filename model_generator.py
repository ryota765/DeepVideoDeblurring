...
class ModelGenerator:
    ...
    def model(self, n_stack=5, input_size=128, epsilon=0.001):
        ...
        inputs = Input(
            shape=(input_size, input_size, 3 * n_stack)
        )  # (height, width, channel*stack)
        ...
        f0_2 = Conv2D(64, kernel_size=3, padding="same")(
            f0_1_
        )  # Add this layer due to tensor shape
        ...
        s3 = Average()(
            [u3, f0_2]
        )  # Change from author implemantation due to tensor shape
